...
def make_vent_dsd_fig_with_wrf_for_date(date, \
    ...
    ax.plot(HALO_bin_radii*1.e6, \
            HALO_y_vals*HALO_bin_radii**2*1.e12/HALO_log_bin_widths, \
    ...
    for versionstr in versionstrs:
        ...
        ax.plot(WRF_bin_radii*1.e6,
                wrf_vent_dsd_dict['data']*WRF_bin_radii**3.*1.e12/WRF_log_bin_widths, \
    ...
    outfile = FIG_DIR + 'halo_slice_meanr_dsd_' + date + '_' + \
