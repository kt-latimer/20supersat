...
def get_ss_pred_and_w_and_z_data(date):
    ...
    ss_pred = get_ss_vs_t_cas(adlr_dict, cas_dict, cip_dict, \
                ...
                incl_rain, incl_vent, 'cip_over_cas')
...
def make_and_save_bipanel_ss_pred_vs_z(ss_pred_dict, z_dict, z_bins):
    ...
    fig.suptitle('Supersaturation and area fraction vertical' \
                            + 'profiles - CAS over CIP - HALO')

    outfile = FIG_DIR + 'cip_over_cas_ss_pred_vs_z_figure.png'
