"""
Make plots comparing d(f*N*r)/dlogDp for HALO and both WRF simulations
"""
import matplotlib
...
def main():
    ...
    make_radius_distribution_fig(spectrum_dict)
...
def make_radius_distribution_fig(spectrum_dict):
    ...
    ax.legend()
    ax.set_title('Drop radius distributions - 1.5-2.5 km')
    
    outfile = FIG_DIR + 'FINAL_compare_radius_distributions_figure.png'
