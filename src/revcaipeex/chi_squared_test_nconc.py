...
from revcaipeex.ss_qss_calculations import get_lwc, get_nconc_vs_t
...
def main():
    ...
    nconc_sim_dict = np.load(dict_dir + 'v2_nconc_sim_dict.npy', \
    ...
    for date in good_dates:#[0:1]:
        ...
        nconc_exp = get_nconc_vs_t(met_dict, dsd_dict, cutoff_bins, \
                                incl_rain, incl_vent)
