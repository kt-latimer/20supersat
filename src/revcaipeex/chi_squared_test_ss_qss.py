...
from revcaipeex.ss_qss_calculations import get_lwc, get_ss_vs_t 
...
def main():
    ...
    ss_sim_dict = np.load(dict_dir + 'v2_ss_sim_dict.npy', \
    ...
    for date in good_dates:#[0:1]:
        ...
        ss_exp = get_ss_vs_t(met_dict, cpd_dict, cutoff_bins, \
