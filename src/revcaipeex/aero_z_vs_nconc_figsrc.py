...
def make_and_save_z_vs_nconc_plot(z, pcasp_nconc, uhsas_nconc, date):
        ...
        ax.scatter(pcasp_nconc*1.e-6, z, label='PCASP')
        ax.scatter(uhsas_nconc*1.e-6, z, label='UHSAS')
        ax.set_xlabel('Nconc (cm^-3)')
        ax.set_ylabel('Altitude (m)')
        ax.set_title(date + ' aerosol nconc vert distb' \
