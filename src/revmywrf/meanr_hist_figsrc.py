...
from revmywrf.ss_qss_calculations import get_lwc, get_meanr
...
def main():
    ...
    for case_label in case_label_dict.keys():
        make_and_save_meanr_hist(case_label, case_label_dict[case_label], \
                                    cutoff_bins, full_ss, incl_rain, \
                                    incl_vent, versionstr)

def make_and_save_meanr_hist(case_label, case_dir_name, \
                                cutoff_bins, full_ss, \
    ...
    ax.set_xlabel('mean r (m)')
    ax.set_ylabel('Count')
    ax.set_title(case_label + ' Mean radius distribution' \
