"""
make and save histograms showing lwc distribution from wrf measurements
"""
import matplotlib
...
def main():
    ...
    for case_label in case_label_dict.keys():
        make_and_save_lwc_hist(case_label, case_label_dict[case_label], \
                                    cutoff_bins, full_ss, incl_rain, \
                                    incl_vent, versionstr)

def make_and_save_lwc_hist(case_label, case_dir_name, \
                                cutoff_bins, full_ss, \
    ...
    ax.set_ylabel('Count')
    ax.set_title(case_label + ' LWC cloud distb' \
