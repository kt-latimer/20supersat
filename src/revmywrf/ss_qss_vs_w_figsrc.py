...
def main():
    ...
    for case_label in case_label_dict.keys():
        make_and_save_ss_qss_vs_w(case_label, case_label_dict[case_label], \
                                    cutoff_bins, full_ss, incl_rain, \
                                    incl_vent, versionstr)

def make_and_save_ss_qss_vs_w(case_label, case_dir_name, \
                                cutoff_bins, full_ss, \
    ...
    ax.set_title(case_label + ' SS_QSS vs vert wind vel' \
                    + ', cutoff_bins=' + str(cutoff_bins) \
                    + ', incl_rain=' + str(incl_rain) \
                    + ', incl_vent=' + str(incl_vent) \
                    + ', full_ss=' + str(full_ss))
    outfile = FIG_DIR + versionstr + 'ss_qss_vs_w_' \
