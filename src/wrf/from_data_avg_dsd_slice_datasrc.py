...
def main():
    ...
    for case_label in case_label_dict.keys():
        ...
        ax.plot(WRF_bin_radii*1.e6,
                wrf_vent_dsd_dict['mean']*WRF_bin_radii/WRF_log_bin_widths, \
...
def make_and_save_avg_dsd(case_label, dsd_dict, vent_dsd_dict):
    ...
    outfile = FIG_DIR + versionstr + 'avg_dsd_slice_' + case_label + '_figure.png'
    ...
    outfile = FIG_DIR + versionstr + 'avg_vent_dsd_slice_' + case_label + '_figure.png'
    plt.savefig(outfile, bbox_inches='tight')
    plt.close()    
