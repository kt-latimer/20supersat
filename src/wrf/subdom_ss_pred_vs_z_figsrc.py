"""
predicted ss versus z with area fraction histogram, restricted to subdomain in
red box of Figure S8 from Fan et al.
"""
import csv
import matplotlib
...
def make_and_save_ss_pred_vs_z(ss_pred_dict, z_dict, z_bins_dict):
    ...
    outfile = FIG_DIR + 'FINAL_subdom_ss_pred_vs_z_figure.png'
