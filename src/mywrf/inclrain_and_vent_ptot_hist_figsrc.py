...
def main():
    ...
    for model_label in model_dirs.keys():
        ...
        P = ncprimvars['P'][...] #pertub press
        PB = ncprimvars['PB'][...] #pertub press
        P = P + PB
        ...
        fig, ax = plt.subplots()
        ax.hist(P[mask1], bins = 40, label='Cloud bulk', density=True)
        ax.hist(P[mask2], bins = 40, label='Cloud edge', density=True)
        ...
        outfile = FIG_DIR + versionstr + 'inclrain_and_vent_ptot_hist_' \
