"""
For (manually-specified) time and vertical coords, create discrete heatmap
where red represents (super)saturated updrafts above the freezing line, blue
represents subsaturated updrafts above the freezing line, and everything else
is grey. Axis and colorbar labels are generated by default right now.
"""
...
def main():
    ...
    for model_label in model_dirs.keys():
        ...
        lh_K_s = ncsecvars['lh_K_s'][33, 44, :, :]
        lwc = ncsecvars['lwc_cloud'][33, 44, :, :]
        ss_qss = ncsecvars['ss_qss'][33, 44, :, :]
        ss_wrf = ncsecvars['ss_wrf'][33, 44, :, :]
        temp = ncsecvars['temp'][33, 44, :, :]
        w = ncsecvars['w'][33, 44, :, :]
        ...
        outfile = FIG_DIR + versionstr + 'inclrain_cloudmap_' \
