...
supersaturation WRF variables *for downdrafts only* and print metadata (i.e. 
...
cdict = {'red':     [(0.0, 0, 0./255.),
                     (1.0, 230./255., 0)],
         'green':   [(0.0, 0, 91./255.),
                     (1.0, 239./255., 0)],
         'blue':    [(0.0, 0, 154./255.),
                     (1.0, 245./255., 0)]}
bluefade = LinearSegmentedColormap('bluefade', cdict)
...
def main():
    ...
    for model_label in model_dirs.keys():
        ...
        #save figure
        outfile = FIG_DIR + versionstr + 'lh_vs_ss_wneg_' \
