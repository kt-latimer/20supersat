...
def main():
    ...
    for model_label in model_dirs.keys():
        ...
        fig, ax = plt.subplots()
        ax.hist(z[mask1], bins = 40, label='Cloud bulk', density=True)
        ax.hist(z[mask2], bins = 40, label='Cloud edge', density=True)
        ...
        outfile = FIG_DIR + versionstr + 'inclrain_and_vent_z_hist_' \
