...
def main():
    ...
    for model_label in model_dirs.keys():
        ...
        fig, ax = plt.subplots()
        ax.hist(temp[mask1], bins = 40, label='Cloud bulk', density=True)
        ax.hist(temp[mask2], bins = 40, label='Cloud edge', density=True)
        ...
        outfile = FIG_DIR + versionstr + 'inclrain_and_vent_temp_hist_' \
