...
def main():
    ...
    for model_label in model_dirs.keys():
        ...
        fig, ax = plt.subplots()
        ax.hist(meanr[mask1], bins = 40, label='Cloud bulk', density=True)
        ax.hist(meanr[mask2], bins = 40, label='Cloud edge', density=True)
        ...
        outfile = FIG_DIR + versionstr + 'inclrain_and_vent_meanr_hist_' \
