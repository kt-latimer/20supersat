...
def main():
    ...
    for data_date_tuple in data_date_tuples:
        ...
        uhsas_labels = ['UHSAS ' + str(t) for t in uhsas_times]

        make_and_save_aero_size_distb_plot(smps_spectra, smps_labels, \
                                            uhsas_spectra, uhsas_labels, \
...
def make_and_save_aero_size_distb_plot(smps_spectra, smps_labels, uhsas_spectra, \
                                    uhsas_labels, fan_aero_size_distb, date):
